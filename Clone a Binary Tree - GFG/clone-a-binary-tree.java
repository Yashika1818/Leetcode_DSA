...
class Solution{
    public Tree cloneTree(Tree tree){
       ...
       addDup(tree);
       setRandom(tree);
       Tree dup=DupSeparate(tree);
       return dup;
     }
     
     public void addDup(Tree root){
         if(root==null)return;
         //stupid call to do smart work in post-order
         addDup(root.left);
         addDup(root.right);
     ...
     public Tree DupSeparate(Tree tree){
         if(tree==null)return null;
         
         Tree ldup=DupSeparate(tree.left.left);
         Tree rdup=DupSeparate(tree.right);
         Tree dup=tree.left;
         tree.left=dup.left;
         dup.left=ldup;
         dup.right=rdup;
